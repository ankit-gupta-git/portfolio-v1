...
const skills = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "n8n", icon: <SiN8N className="text-orange-500 hover:scale-110 transition-transform duration-300" />, animation: 'hover:scale-110' },
      { name: "Pinecone", icon: <FaDatabase className="text-blue-500 hover:animate-pulse transition-all duration-300" />, animation: 'hover:animate-pulse' },
    ],
  },
  {
